...
<head>
    <title>SkillMaster - Education becomes easy with us.</title>
    <meta charset="UTF-8">
...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <a class="navbar-brand" href="index-2.html">
                            ...
                            <img class="sticky-logo" src="{{ asset('assets/images/logo4.png') }}" alt="">
                        </a>
                        <!-- logo End-->
    ...
    <!-- Hero Banner Start -->
    <section class="hero-banner-1" style="background-image: url({{ asset('assets/images/home/banner.png') }});">
        <!-- shape -->
        <div class="shape-wrap">
            <div class="b-shape-1">
                <img src="{{ asset('assets/images/home/shape-1.png') }}" alt="">
            </div>
            <div class="b-shape-2">
                <img src="{{ asset('assets/images/home/shape-2.png') }}" alt="">
            </div>
            <div class="b-shape-3">
                <img src="{{ asset('assets/images/home/shape-3.png') }}" alt="">
            </div>
            <div class="b-shape-4">
                <img src="{{ asset('assets/images/home/shape-4.png') }}" alt="">
            </div>
        </div>
        <!-- shape -->
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5">
                    <div class="hero-content">
                        ...
                        <p>
                            Loo you mug lurgy baking cakes boot cracking goal morish up the duff haggle hotpot faff
                            about no biggie burke, is bleeder bamboozled bite your.
                        </p>
                ...
                <div class="col-lg-7 col-md-7">
                    <div class="banner-thumb">
                        <img src="{{ asset('assets/images/home/layer.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="popular-course-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a class="read-more" href="#">Browse Online Courses<i class="arrow_right"></i></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="course-wrapper">
                        <div class="course-item-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="74" height="60" viewBox="0 0 74 60">
                                <defs>
                                    <style>
                                        .cls-1 {
                                            fill: url(#pattern);
                                    ...
                                    <pattern id="pattern" preserveAspectRatio="xMidYMid slice" width="100%"
                                        height="100%" viewBox="0 0 74 60">
                                        <image width="74" height="60"
                                            xlink:href="{{ asset('assets/images/home/desktop1-image.png') }}" />
                                    </pattern>
                                </defs>
                        ...
                        <div class="course-item-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <image id="data" width="64" height="64"
                                    xlink:href="{{ asset('assets/images/home/data-image.png') }}" />
                            </svg>
                            <h4><a href="single-course.html">Data Analysis & Statistics</a></h4>
                        </div>
                        <div class="course-item-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="74" height="70" viewBox="0 0 74 70">
                                <image id="proposal" width="74" height="70"
                                    xlink:href="{{ asset('assets/images/home/proposal-image.png') }}" />
                            </svg>
                            <h4><a href="single-course.html">Business & Management</a></h4>
                        </div>
                        <div class="course-item-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="80" height="67" viewBox="0 0 80 67">
                                <image id="chat" width="80" height="67"
                                    xlink:href="{{ asset('assets/images/home/chat-image.png') }}" />
                            </svg>
                            <h4><a href="single-course.html">Social Sciences</a></h4>
                        </div>
                        <div class="course-item-1 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="58" height="73" viewBox="0 0 58 73">
                                <image id="mind" width="58" height="73"
                                    xlink:href="{{ asset('assets/images/home/mind-image.png') }}" />
                            </svg>
            ...
            <div class="row mt-120">
                <div class="col-lg-7 col-md-6">
                    <div class="ab-thumb">
                        <img src="{{ asset('assets/images/home/1.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-5 col-md-6">
                    <div class="ab-content">
                        <h3>I will stay with you until you pass your exam.</h3>
                        <p class="mid-item">Who else do you know who'll do that for you?</p>
                        <p>
                            So I said codswallop car boot cheers mufty I don't want no agro are you taking the piss
                            cheeky my lady gutted mate excuse my french, gormless have it cras.
                        </p>
                        <a class="bisylms-btn" href="#">Know More</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="feature-course-section">
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <h2 class="sec-title"><span>Find the Right</span> Online Course for you</h2>
                </div>
                <div class="col-md-7">
                    ...
                    <div class="feature-course-item">
                        <div class="flipper">
                            ...
                            <div class="back">
                                ...
                                <a href="#" class="c-cate">Computer Science</a>
                                ...
                                <div class="author">
                                    <img src="{{ asset('assets/images/home/course/author.png') }}" alt="">
                                    <a href="#">Anthony</a>
                                </div>
                                <div class="fcf-bottom">
                                    <a href="#"><i class="icon_book_alt"></i>10 Lessons</a>
                ...
                <div class="col-lg-4 col-md-6 shaf-item" data-groups='["all", "architecture"]'>
                    <div class="feature-course-item">
                        <div class="flipper">
                            <div class="front">
                                <div class="fcf-thumb">
                                    <img src="{{ asset('assets/images/home/course/2.png') }}" alt="">
                                </div>
                                <p>Art & Design</p>
                ...
                <div class="col-lg-4 col-md-6 shaf-item" data-groups='["all", "development"]'>
                    <div class="feature-course-item">
                        <div class="flipper">
                            <div class="front">
                                <div class="fcf-thumb">
                                    <img src="{{ asset('assets/images/home/course/4.png') }}" alt="">
                                </div>
                                <p>Web Development</p>
                                <h4>Making Music with Other People</h4>
                                <div class="fcf-bottom">
                                    <a href="#"><i class="icon_book_alt"></i>12 Lessons</a>
                                    <a href="#"><i class="icon_profile"></i>124</a>
                                </div>
                            </div>
                            <div class="back">
                                <div class="fcf-thumb">
                        ...
                        <div class="flipper">
                            <div class="front">
                                ...
                                <div class="fcf-bottom">
                                    ...
                                    <a href="#"><i class="icon_profile"></i>102</a>
                                </div>
                            </div>
                            <div class="back">
                                <div class="fcf-thumb">
                                ...
                                <a href="#" class="c-cate">UI/UXDesign</a>
                ...
                <div class="col-lg-4 col-md-6 shaf-item" data-groups='["all", "science"]'>
                    <div class="feature-course-item">
                        <div class="flipper">
                            <div class="front">
                                <div class="fcf-thumb">
                                    <img src="{{ asset('assets/images/home/course/6.png') }}" alt="">
                                </div>
                                <p>Data Science</p>
    ...
    <!-- Cta Start -->
    <section class="cta-section" style="background-image: url({{ asset('assets/images/home/cta-bg.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="sec-title"><span>Online Course</span> From 160 Top Institutions.</h2>
                    <p>
                        So I said codswallop car boot cheers mufty I don't want no agro are you taking the<br> piss
                        cheeky my lady gutted mate excuse my french.
                    </p>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 text-center">
                    <div class="video-banner"
                        style="background-image: url({{ asset('assets/images/home/video-bg.jpg') }});">
                        <a class="popup-video" href="https://player.vimeo.com/video/101626307"
                            data-rel="lightcase"><i class="fas fa-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="package-section"
        style="background-image: url({{ asset('assets/images/home/package-bg.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="sec-title"><span>Online Learning</span> Offers 3 Types of Membership Packages</h2>
                </div>
            </div>
                    ...
                    <div id="card-slider" class="pack-slider">
                        <div class="package-item">
                            <div class="pack-thumb">
                                ...
                                <div class="pack-middle">
                                    <img src="{{ asset('assets/images/home/gold.png') }}" alt="">
                                </div>
                            </div>
                            <div class="pack-details">
                                <div class="pack-price"><span>$750</span> $450 / 2 Year(s)</div>
                                <h3>Gold Membership</h3>
                                <div class="pack-meta">
                                    <span><i class="icon_book_alt"></i>12 Lessons</span>
                                    <span><i class="icon_toolbox_alt"></i>3 Classes</span>
                                </div>
                                <p>
                                    He nicked it I don't want no agro what a load of rubbish bleeding skive off
                                    tickety-boo hunky dory chancer.
                                </p>
                                <a href="#" class="bisylms-btn">Apply Now</a>
                            </div>
                        </div>
                        <div class="package-item">
                            <div class="pack-thumb">
                                ...
                                <div class="pack-middle">
                                    <img src="{{ asset('assets/images/home/silver.png') }}" alt="">
                                </div>
                            </div>
                            <div class="pack-details">
                                <div class="pack-price"><span>$750</span> $450 / 2 Year(s)</div>
                        ...
                        <div class="package-item">
                            <div class="pack-thumb">
                                ...
                                <div class="pack-middle">
                                    <img src="{{ asset('assets/images/home/bronze.png') }}" alt="">
                                </div>
                            </div>
                            <div class="pack-details">
                                <div class="pack-price"><span>$750</span> $450 / 2 Year(s)</div>
    ...
    <!-- Blog Start -->
    <section class="blog-section" style="background-image: url({{ asset('assets/images/home/blog-bg.png') }});">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="cta-wrapper">
                        <img src="{{ asset('assets/images/home/2.png') }}" alt="">
                ...
                <div class="col-lg-4 col-md-3">
                    <aside class="widget">
                        <div class="about-widget">
                            <a href="index-2.html"><img src="{{ asset('assets/images/logo.png') }}"
                                    alt=""></a>
                            <p>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="copyright">
                        <p>© 2021 Copyright all Right Reserved Design by <a
                                href="http://quomodosoft.com/">Quomodosoft</a></p>
                    </div>
                </div>
            </div>
            <!-- Copyrigh -->
